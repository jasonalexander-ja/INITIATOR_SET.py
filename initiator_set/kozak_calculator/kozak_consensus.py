...
def new_KzConsensus(start_codon: int, *anynomous_weights_objects: Iterable[object]):
    ...
    if type(o) in [list, tuple]:
        ...
        raise ValueError
    for i in range(start_codon, start_codon+3):
        sq[i].importance = -1
    return KzConsensus(codonStart=start_codon, sequence=sq)
